      ...
      >
        <Row justify="center">
          <Col span={10}>
            ...
            >
              <Select placeholder="Please select a Menu">
                <Option value="china">panner</Option>
                <Option value="usa">daal</Option>
              </Select>
            </Form.Item>
            ...
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: "Please select your Min!",
                },
              ]}
            >
              <Select placeholder="Min">
                <Option value="china">$100%</Option>
                <Option value="usa">$200%</Option>
              </Select>
            </Form.Item>
          </Col>
          ...
          <Col span={10}>
            ...
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: "Please select your cty!",
                },
              ]}
            >
